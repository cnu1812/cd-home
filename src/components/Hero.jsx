  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 overflow-hidden pt-20">
      ...
      <motion.div
        ...
        transition={{ duration: 1, delay: 3.5 }} // Syncs with Logo Animation
        className="max-w-3xl mx-auto relative z-20 mt-[-20px]"
      >
        ...
        <motion.div 
          ...
          className="absolute bottom-[-80px] left-1/2 -translate-x-1/2 text-cyan-500/50"
        >
          <ChevronDown size={32} />
        </motion.div>
      </motion.div>
